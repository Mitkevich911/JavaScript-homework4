...
let getWeekDay = (d) => {
  ...
  console.log(getWeekDay('2019-01-15')); 
  console.log(getWeekDay('2019-08-11')); 
  console.log(getWeekDay('2019-04-27')); 
  ...
  console.log(getLocalDay('2019-03-19'));
  console.log(getLocalDay('2019-01-18'));
  console.log(getLocalDay('2019-11-23'));
...
console.log(getDateAgo('2019-01-22', 1)); 
console.log(getDateAgo('2019-01-22', 2)); 
console.log(getDateAgo('2019-01-22', 365)); 
